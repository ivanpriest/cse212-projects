...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Expected the next person to be Bob, but the code returned Sue.
    ...
    // Defect(s) Found: Expected the next person to be Tim, but the code returned Sue.
